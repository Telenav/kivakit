...
/**
 * A map from int keys to long values. Supports typical map functions:
 * <p>
 * <b>Access</b>
 * <ul>
 *     <li>{@link #get(int)} </li>
 *     <li>{@link #put(int, long)}</li>
...
public final class IntToLongMap extends PrimitiveMap implements PrimitiveScalarMap
{
    /**
    ...
    public IntToLongMap(final String objectName)
    {
        super(objectName);
    }

    protected IntToLongMap()
    {
    }
    ...
    public boolean equals(final Object object)
    {
        ...
        {
            final var that = (IntToLongMap) object;
            if (this == that)
            {
                return true;
            }
    ...
    protected void copy(final PrimitiveMap uncast)
    {
        ...
        final var that = (IntToLongMap) uncast;
        keys = that.keys;
        values = that.values;
    }
     ...
     */
    @Override
    protected IntToLongMap newMap()
    {
        return new IntToLongMap(objectName());
    }
