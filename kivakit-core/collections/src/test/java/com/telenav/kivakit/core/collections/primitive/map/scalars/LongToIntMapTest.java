...
public class LongToIntMapTest extends CoreCollectionsUnitTest
{
    @FunctionalInterface
    interface MapTest
    {
    ...
    {
        return (LongToIntMap) new LongToIntMap("test").nullLong(Long.MIN_VALUE).nullInt(Integer.MIN_VALUE).initialize();
    }
