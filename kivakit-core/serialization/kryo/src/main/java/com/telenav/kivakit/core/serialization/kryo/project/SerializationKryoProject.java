...
package com.telenav.kivakit.core.serialization.kryo.project;
...
{
    private static final Lazy<SerializationKryoProject> project = Lazy.of(SerializationKryoProject::new);
