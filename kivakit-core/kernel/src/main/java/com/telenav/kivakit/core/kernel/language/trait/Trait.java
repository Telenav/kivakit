 ...
 * #value(Class, Factory)}. This obviates the need for hand delegation of an aggregate value when providing an interface
...
{
    default <T> T value(final Class<? extends Trait> type, final Factory<T> factory)
    {
