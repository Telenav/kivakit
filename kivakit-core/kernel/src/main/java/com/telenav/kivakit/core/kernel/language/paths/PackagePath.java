...
public final class PackagePath extends StringPath
{
    ...
    {
        return packagePath(type, StringPath.parseStringPath(type.getName(), null, "\\.").withoutLast());
    }
    ...
    {
        final var parent = StringPath.parseStringPath(type.getPackageName(), "\\.");
    ...
    {
        final var path = StringPath.parseStringPath(relativePath, "/", "/");
