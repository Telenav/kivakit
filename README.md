...
[**Javadoc**](https://www.kivakit.org/0.9.18/javadoc/kivakit)  <!-- [cactus.replacement-version] -->   
[**CodeFlowers**](https://www.kivakit.org/0.9.18/codeflowers/site/index.html)  <!-- [cactus.replacement-version] -->  
...
| *Setup*             | [Step-by-step setup instructions](https://github.com/Telenav/telenav-build/blob/release/0.9.18/documentation/initial-setup-instructions.md) <!-- [cactus.replacement-branch-name] -->                                                               |
...
[**Code Quality**](#code-quality) | 
[**Java 17+ Migration Notes**](https://github.com/Telenav/telenav-build/blob/release/0.9.18/documentation/java-migration-notes.md)  <!-- [cactus.replacement-branch-name] --> | 
[**Downloads**](#downloads)
