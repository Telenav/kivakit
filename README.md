...
[**How to Build This Project**](https://github.com/Telenav/telenav-build/blob/release/current/documentation/building.md) <!-- [branch-name] --> 
...
[**Initial Setup**](https://github.com/Telenav/telenav-build/blob/release/current/documentation/initial-setup-instructions.md)  <!-- [branch-name] -->  
[**Building**](https://github.com/Telenav/telenav-build/blob/release/current/documentation/building.md)  <!-- [branch-name] -->  
...
[**Developing**](https://github.com/Telenav/telenav-build/blob/release/current/documentation/developing.md) <!-- [branch-name] -->  
[**Releasing**](https://github.com/Telenav/telenav-build/blob/release/current/documentation/releasing.md) <!-- [branch-name] -->
...
| *Setup*             | [Step-by-step setup instructions](https://github.com/Telenav/telenav-build/blob/release/current/documentation/initial-setup-instructions.md) <!-- [branch-name] -->                  |
...
[**Java 17+ Migration Notes**](https://github.com/Telenav/telenav-build/blob/release/current/documentation/java-migration-notes.md)  <!-- [branch-name] --> | 
[**Downloads**](#downloads)
