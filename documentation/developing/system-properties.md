...
| **KIVAKIT_DEBUG** | Turns on/off debug traces for packages and classes matching a series of one or more patterns. See [kivakit-kernel debugging](../../kivakit-kernel/documentation/messaging-debugging.md) and Javadoc in Debug.java
...
| **KIVAKIT_LOG** | A comma-separated list of logs to send log entries to along with their configurations. See [kivakit-kernel logging](../../kivakit-kernel/documentation/logging.md) |
...
| **KIVAKIT_LOG_LEVEL** | Restricts the output to a entries of the given and higher severities. See [kivakit-kernel logging](../../kivakit-kernel/documentation/logging.md) |
