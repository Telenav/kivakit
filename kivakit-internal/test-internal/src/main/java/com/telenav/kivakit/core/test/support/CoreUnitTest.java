...
package com.telenav.kivakit.core.test.support;
...
import com.telenav.kivakit.core.test.support.lexakai.DiagramTest;
 ...
 * true will be executed. Alternatively, quick tests can be labeled with the {@link QuickTest} annotation.
 *
