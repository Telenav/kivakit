...
public class ExtractionTest extends CoreUnitTest
{
    ...
    public void testArrayExtraction()
    {
        ...
        ensureEqual(extractor.extractAll(new String[] { "12", "13", "14" }), ObjectList.list(12, 13, 14));
    }
    ...
    {
        var extractor = new TestExtractor(Listener.consoleListener());
        ensureEqual(extractor.extractAll(StringList.stringList("12", "13", "14")), ObjectList.list(12, 13, 14));
    }
}
