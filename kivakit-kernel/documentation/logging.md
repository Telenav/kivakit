...
The other properties give additional examples.
    ...
    -DKIVAKIT_LOG="Server level=Warning maximum-entries=1.1.0,Email level=CriticalAlert subject=Alert from=jonathanl@telenav.com to=jonathanl@telenav.com host=smtp.telenav.com username=jonathanl@telenav.com password=shibo"
