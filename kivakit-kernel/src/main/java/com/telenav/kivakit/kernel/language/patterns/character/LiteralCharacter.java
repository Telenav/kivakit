...
package com.telenav.kivakit.kernel.language.patterns.character;

import com.telenav.kivakit.kernel.language.patterns.Expression;
...
{
    public LiteralCharacter(char pattern)
    {
        super("\\" + pattern);
    }
}
