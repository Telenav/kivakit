## Contributing to Telenav Projects
...
4. The pull request should be formatted according to Telenav style (see [release/1.7.1-SNAPSHOT](https://github.com/Telenav/telenav-build/blob/release/current/documentation/developing.md))   <!-- [cactus.replacement-branch-name] -->
