...
4. The pull request should be formatted according to Telenav style (see [release/1.5.37](https://github.com/Telenav/telenav-build/blob/release/current/documentation/developing.md))   <!-- [cactus.replacement-branch-name] -->
