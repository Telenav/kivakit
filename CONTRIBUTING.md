...
4. The pull request should be formatted according to Telenav style (see [releases/1.5.39](https://github.com/Telenav/telenav-build/blob/releases/documentation/developing.md))   <!-- [cactus.replacement-branch-name] -->
