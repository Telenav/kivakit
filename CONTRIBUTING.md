...
4. The pull request should be formatted according to Telenav style (see [1.8.5](https://github.com/Telenav/telenav-build/blob/releases/documentation/releasing.md))   <!-- [cactus.replacement-branch-name] -->
