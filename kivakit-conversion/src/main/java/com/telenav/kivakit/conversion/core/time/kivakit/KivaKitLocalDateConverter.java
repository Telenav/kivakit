...
/**
 * Converts local dates to and from a KivaKit-defined format that is a valid filename across Mac, Linux and Windows
 * operating systems
 *
...
public class KivaKitLocalDateConverter extends BaseLocalTimeConverter
{
     ...
     */
    public KivaKitLocalDateConverter(Listener listener)
    {
        super(listener, KIVAKIT_DATE, ZoneId.systemDefault());
    }
