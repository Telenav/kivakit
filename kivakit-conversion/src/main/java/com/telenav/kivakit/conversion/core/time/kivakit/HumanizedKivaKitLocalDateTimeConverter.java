...
public class HumanizedKivaKitLocalDateTimeConverter extends BaseStringConverter<LocalTime>
{
     ...
     */
    public HumanizedKivaKitLocalDateTimeConverter(Listener listener)
    {
        super(listener, LocalTime.class);
    }

    public HumanizedKivaKitLocalDateTimeConverter()
    {
    ...
    {
        return humanizedDate(time)
            + " "
            + new KivaKitLocalTimeConverter(this, time.timeZone()).unconvert(time);
    }
    ...
    protected LocalTime onToValue(String value)
    {
        ...
        if (matcher.matches())
        {
            var localTime = new KivaKitLocalTimeConverter(this, localTimeZone())
            ...
            if (localTime != null)
            {
                ...
                if (date != null)
                {
                    var localDate = new KivaKitLocalDateConverter(this).convert(date);
                    if (localDate != null)
                    {
    ...
    private String humanizedDate(LocalTime time)
    {
        ...
        return new KivaKitLocalDateConverter(this).unconvert(time);
    }
}
