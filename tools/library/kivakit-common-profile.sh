...
echo "┋"
echo "┋        KIVAKIT_WORKSPACE: ${ATTENTION}$KIVAKIT_WORKSPACE${NORMAL}"
echo "┋             KIVAKIT_HOME: ${ATTENTION}$KIVAKIT_HOME${NORMAL}"
echo "┋          KIVAKIT_VERSION: ${ATTENTION}$KIVAKIT_VERSION${NORMAL}"
echo "┋            KIVAKIT_BUILD: ${ATTENTION}$KIVAKIT_BUILD${NORMAL}"
echo "┋"
